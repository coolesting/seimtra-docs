...
#new a record
get '/system/setting/new' do

	@title = 'Create a new setting'
	sys_opt :save
	setting_set_fields
	slim :system_setting_form

end

post '/system/setting/new' do
...
#edit the record
get '/system/setting/edit/:skey' do
...
post '/system/setting/edit/:skey' do
